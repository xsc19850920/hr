package com.rs.hr.common.google;
...
//		String format = "http://www.google.com/chart?chs=200x200&chld=M%%7C0&cht=qr&chl=otpauth://totp/%s@%s?secret=%s";
        String format = "https://cli.im/api/qrcode/code?text=otpauth://totp/%s@%s?secret=%s&mhid=sELPDFnok80gPHovKdI&issuer=hr";
    ...
    public static String getQRBarcode(String user, String secret) {
        String format = "otpauth://totp/%s?secret=%s&issuer=hr";
